                    ...
                    <table class="table table-bordered">
                        <tr>
                            ...
                            <tr>
                                ...
                                <td class="text-center"><a style="color:#333333;font-weight: bold;" href="" style="white-space:unset;text-align: justify;">{{$k->ma_kh}}<i class="fa fa-edit"></i></a></td>
                                <td class="text-center">
                                    @foreach($listsp as $u) 
                                    @if($u->id == $k->id_sanpham)
                                    {{$u->name}}
                                    @endif
                                    @endforeach
                                </td>
                                <td class="text-center">{{$k->so_luong}}</td>
                                </tr>
                                @endforeach
