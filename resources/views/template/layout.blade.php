        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu" data-widget="tree">
                <li class=" active menu-open ">
                    ...
                    <ul class="treeview-menu">
                        <li><a href="/danhmuc"><i
                                    class="fa fa-circle-o"></i> danh mục</a></li>
                    </ul>
                    <ul class="treeview-menu">
                        <li><a href="/sanpham"><i
                    ...
                    <ul class="treeview-menu">
                        <li><a href="/khuyenmai"><i
                                    class="fa fa-circle-o"></i> khuyến mãi</a></li>
                    </ul>
                    <ul class="treeview-menu">
                        <li><a href="/hoadon"><i
                                    class="fa fa-circle-o"></i> hóa đơn tổng</a></li>
                    </ul>
                    <ul class="treeview-menu">
                        <li><a href="/chi_tiet_hoadon"><i
                                    class="fa fa-circle-o"></i> chi tiết hóa đơn</a></li>
                    </ul>
                    <ul class="treeview-menu">
                        <li><a href="/size"><i
                                    class="fa fa-circle-o"></i> size</a></li>
                    </ul>
                    <ul class="treeview-menu">
                        <li><a href="/Chi_tiet_size"><i
                                    class="fa fa-circle-o"></i> chi tiết size</a></li>
                    </ul>
                </li>
            </ul>
        </section>
