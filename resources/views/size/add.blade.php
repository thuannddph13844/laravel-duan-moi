            ...
            <div class="box-body">
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            <label for="name" class="col-md-3 col-sm-4 control-label">size<span class="text-danger">(*)</span></label>
                            <div class="col-md-9 col-sm-8">
                                <input type="size" name="size" id="size" class="form-control" value="@isset($request['size']){{ $request['size'] }}@endisset">
                                <span id="mes_sdt"></span>
                            </div>
