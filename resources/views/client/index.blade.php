...
<body>
                ...
                <nav class="collapse position-absolute navbar navbar-vertical navbar-light align-items-start p-0 bg-light" id="navbar-vertical" style="width: calc(100% - 30px); z-index: 999;">
                    <div class="navbar-nav w-100">
                        @foreach($listdm as $item)
                            <a href="" class="nav-item nav-link">{{$item->name_cate}}</a>
                        @endforeach
                    </div>
                </nav>
            </div>
    ...
    <div class="container-fluid pt-5 pb-3">
        ...
        <div class="row px-xl-5">
            @foreach($listsp as $itemProduct)
            <div class="col-lg-3 col-md-4 col-sm-6 pb-1">

                <div class="product-item bg-light mb-4">
                    <div class="product-img position-relative overflow-hidden">
                        <img class="img-fluid w-100" src="{{ $itemProduct->hinh?''.Storage::url($itemProduct->hinh):'http://placehold.it/100x100' }}" WIDTH="227px" height="227px" alt="">
                    ...
                    <div class="text-center py-4">
                        <a class="h6 text-decoration-none text-truncate" href="/detail/{{$itemProduct->id}}">{{$itemProduct->name}}</a>
