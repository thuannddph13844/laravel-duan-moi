                ...
                <div class="double-scroll">
                    <table class="table table-bordered">
                        <tr>
                            ...
                            <th class="text-center">thuộc bill tổng</th>
                            ...
                            <tr>
                                ...
                                <td class="text-center"><a style="color:#333333;font-weight: bold;" href="" style="white-space:unset;text-align: justify;">{{$ct->name}}<i class="fa fa-edit"></i></a></td> 
                                {{-- sản phẩm --}}
                                <td class="text-center">
                                    @foreach($listsp as $s)
                                    @if($ct->id_san_pham == $s->prod_id) 
                                    {{$s->name}}
                                    @endif
                                    @endforeach
                                </td>
                                <td class="text-center">{{$ct->price}}</td>
                                {{-- người dùng  --}}
                                <td class="text-center">
                                    @foreach($list as $u)
                                    @if($ct->id_user == $u->id)
