                    ...
                    <div class="col-xs-12" style="text-align:center;">
                        <div class="form-group">
                            ...
                            <a href="{{ url('/user') }}" class="btn btn-default btn-sm "><i class="fa fa-remove"></i>
                                Clear </a>
                            <a href="/sanpham/add" class="btn btn-info btn-sm"><i class="fa fa-user-plus" style="color:white;"></i>
                                Add new</a>
                        </div>
                    </div>
                </div>
                    ...
                    <table class="table table-bordered">
                        <tr>
                            ...
                            <tr>
                                ...
                                <td class="text-center"><a style="color:#333333;font-weight: bold;" href="/sanpham/detail/{{$u->id}}" style="white-space:unset;text-align: justify;">{{$u->name}}<i class="fa fa-edit"></i></a></td>
                                <td class="text-center">{{$u->price}}</td>
                                <td class="text-center">{{$u->mo_ta}}</td>
                                <td class="text-center">{{$u->so_luong}}</td>
                                
                                <td class="text-center">@foreach($listdm as $d)
                                    @if( $d->cate_id == $u->id_danhmuc) 
                                    {{$d->name_cate}}
                                     @endif
                                    @endforeach
                                </td>
