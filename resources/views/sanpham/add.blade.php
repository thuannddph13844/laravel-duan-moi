            ...
            <div class="box-body">
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            <label for="name" class="col-md-3 col-sm-4 control-label">tên sp<span class="text-danger">(*)</span></label>
                            <div class="col-md-9 col-sm-8">
                                <input type="name" name="name" id="name" class="form-control" value="@isset($request['name']){{ $request['name'] }}@endisset">
                                <span id="mes_sdt"></span>
                            </div>
                        </div> 
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label for="so_luong" class="col-md-3 col-sm-4 control-label">số lượng<span class="text-danger">(*)</span></label>
                            <div class="col-md-9 col-sm-8">
                                <input type="text" name="so_luong" id="so_luong" class="form-control" value="@isset($request['so_luong']){{ $request['so_luong'] }}@endisset">
                                <span id="mes_sdt"></span>
                            </div>
                        </div>
                        <div class="form-group">
