...
<body>
    ...
    @if($newcart == [])
        <h1>Bạn k có sp nào trong giỏ hàng</h1>
            ...
            <div class="col-lg-8 table-responsive mb-5">
                <table class="table table-light table-borderless table-hover text-center mb-0">
                    ...
                    @foreach($newcart -> products as $item)
                        <tr>
                            <td class="align-middle"><img src="{{ $item['proInfor'] -> hinh?''.Storage::url($item['proInfor']->hinh    ):'http://placehold.it/100x100' }}" alt="" style="width: 50px;"> {{$item['proInfor']->name}}</td>
                ...
                <div class="bg-light p-30 mb-5">
                    <div class="border-bottom pb-2">
                        <div class="d-flex justify-content-between mb-3">
                            <h6>Tổng tiền</h6>
                            <h6>{{$newcart->totalPrice}}</h6>
                        </div>
                        <div class="d-flex justify-content-between mb-3">
                            <h6>Tổng số sản phẩm</h6>
                            <h6>{{$newcart->totalQuantity}}</h6>
                        </div>
                    </div>
                    <div class="pt-2">
