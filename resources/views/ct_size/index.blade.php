                    ...
                    <div class="col-xs-12" style="text-align:center;">
                        <div class="form-group">
                            ...
                            <a href="{{ url('/user') }}" class="btn btn-default btn-sm "><i class="fa fa-remove"></i>
                                Clear </a>
                            <a href="/Chi_tiet_size/add" class="btn btn-info btn-sm"><i class="fa fa-user-plus" style="color:white;"></i>
                                Add new</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="double-scroll">
                    <table class="table table-bordered">
                        <tr>
                            ...
                            <th class="text-center">id_size</th>
                        </tr>
                      
                            @foreach($listsize as $u)
                            <tr>
                                {{--<td><input type="checkbox" name="chk_hv[]" class="chk_hv" id="chk_hv_{{$item->id}}" value="{{$item->id}}"> </td>--}}
                                <td class="text-center">{{$u->id_sanpham}}</td>
                                
                                <td class="text-center">{{$u->id_size}}</td>
